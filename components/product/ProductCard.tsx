...
export function ProductCard({ product, showColors = true, compactMobile = false, minimal = false }: ProductCardProps) {
  ...
  return (
    ...
    >
      ...
      <div className={cn('space-y-3', compactMobile && 'max-md:flex max-md:flex-1 max-md:flex-col max-md:justify-center max-md:space-y-2 max-md:pr-1')}>
        ...
        {!minimal && showColors && product.colors && product.colors.length > 0 && (
